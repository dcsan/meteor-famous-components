...
Meteor.startup(function() {
    ...
    if (famousCmp.mainCtx)
        ...
        if (famousCmp.mainCtx !== false)
            console.log('[famousCmp] Creating a new main context.  If you already have ' + 'your own, set famousCmp.mainCtx = yourMainContext (or to false to get ' + 'rid of this warning)');
...
CompView = function(component, options) {
    ...
    parent = parent ? parent.famousView : {
        node: mainCtx
    };
